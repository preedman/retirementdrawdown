...
export declare const CrudEdit: (props: Partial<import("@vaadin/react-components/utils/createComponent.d.ts").ThemedWebComponentProps<CrudEditElement, Readonly<{
    onEdit: EventName<CustomEvent<unknown>>;
