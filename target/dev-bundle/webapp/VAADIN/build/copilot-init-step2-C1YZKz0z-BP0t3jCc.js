import { $ as $$1, M as Mi, h as al, b as _$1, I as Ii, Y as Ya, a as _s, l as fe$1, J as Jt, n as _l, o as ce$1, Q as Qa, D as Dl, q as fl, z as zi, _ as _r, s as Xe, C as Cl, v as vl, E, V as Vl, R as Rl, O as Ol } from "./indexhtml-B7WNcaKJ.js";
import { g as g$1, h } from "./state-eevs1asN-CG66D4x8.js";
import { p, y } from "./overlay-monkeypatch-BpxWVdY5-9PtU06cT.js";
import { r as r$1 } from "./icons-DrBP115r-ULtKT6RW.js";
import { h as h$1 } from "./unsafe-html-B3_veTIk-gxdljWTS.js";
import { K } from "./react-utils-DFD62MFY-DV-Nu30T.js";
import { showNotification as N, dismissNotification as c } from "./copilot-notification-CBUUP7Vd-behwOuXu.js";
/**
 * @license
...
let m = class extends _s {
    ...
    super(...arguments), this.position = "right", this.opened = false, this.keepOpen = false, this.resizing = false, this.closingForcefully = false, this.draggingSectionPanel = null, this.activationAnimationTransitionEndListener = () => {
      ...
      e.stopPropagation(), e.preventDefault(), requestAnimationFrame(() => {
        ...
        if (this.position === "right") {
          ...
          this.style.setProperty("--size", `${i}px`), fe$1.saveDrawerSize(this.position, i), o = { width: i };
        } else if (this.position === "left") {
          const i = t;
          this.style.setProperty("--size", `${i}px`), fe$1.saveDrawerSize(this.position, i), o = { width: i };
        } else if (this.position === "bottom") {
          const i = document.body.clientHeight - n;
          this.style.setProperty("--size", `${i}px`), fe$1.saveDrawerSize(this.position, i), o = { height: i };
        }
        Jt.panels.filter((i) => !i.floating && i.panel === this.position).forEach((i) => {
          Jt.updatePanel(i.tag, o);
        });
      });
    }, this.sectionPanelDraggingStarted = (e, t) => {
      this.draggingSectionPanel = e, $$1.emit("user-select", { allowSelection: false }), this.draggingSectionPointerStartY = t.clientY, e.toggleAttribute("dragging", true), e.style.zIndex = "1000", Array.from(this.querySelectorAll("copilot-section-panel-wrapper")).forEach((n, o) => {
        n.setAttribute(_, `${o}`);
      ...
      if (!_l(this.getBoundingClientRect(), t, n)) {
      ...
      if (!this.draggingSectionPanel)
        return;
      $$1.emit("user-select", { allowSelection: true });
      ...
      this.cleanUpDragging(), Jt.updateOrders(e), document.removeEventListener("mouseup", this.sectionPanelDraggingFinished), document.removeEventListener("mousemove", this.sectionPanelDragging);
  ...
  connectedCallback() {
    super.connectedCallback(), this.reaction(
      ...
      () => _$1.operationInProgress,
      (t) => {
        t === Dl.DragAndDrop && !this.opened && !this.keepOpen ? this.style.setProperty("pointer-events", "none") : this.style.setProperty("pointer-events", "auto");
      }
    ), this.reaction(
      () => Jt.getAttentionRequiredPanelConfiguration(),
      () => {
        const t = Jt.getAttentionRequiredPanelConfiguration();
        t && !t.floating && this.toggleAttribute(fl, t.panel === this.position);
      }
    ), this.reaction(
      () => _$1.active,
      () => {
        if (!_$1.active || !zi.isActivationAnimation() || _$1.activatedFrom === "restore" || _$1.activatedFrom === "test")
          return;
        const t = Jt.getAttentionRequiredPanelConfiguration();
      ...
      this.resizing = false, _$1.setDrawerResizing(false), this.removeAttribute("resizing"), $$1.emit("user-select", { allowSelection: true });
    });
    const e = fe$1.getDrawerSize(this.position);
  ...
  firstUpdated(e) {
    super.firstUpdated(e), requestAnimationFrame(() => this.toggleAttribute("no-transition", false)), this.resizeElement.addEventListener("mousedown", (t) => {
      t.button === 0 && (this.resizing = true, _$1.setDrawerResizing(true), this.setAttribute("resizing", ""), $$1.emit("user-select", { allowSelection: false }));
    });
  }
  updated(e) {
    super.updated(e), e.has("opened") && this.opened && this.hasAttribute(fl) && (this.removeAttribute(fl), Jt.clearAttention()), this.updateScrollable();
  }
   ...
   */
  cleanUpDragging() {
    this.draggingSectionPanel && (_$1.setSectionPanelDragging(false), this.draggingSectionPanel.style.zIndex = "", Array.from(this.querySelectorAll("copilot-section-panel-wrapper")).forEach((e) => {
  ...
  mouseEnterListener(e) {
    if (this.closingForcefully || _$1.sectionPanelResizing)
      return;
...
class ue {
  ...
  dragging(t, n) {
    const o = n.clientX, i = n.clientY, r = o - this.offsetX, s = o - this.offsetX + t.getBoundingClientRect().width, d = i - this.offsetY, h2 = i - this.offsetY + t.getBoundingClientRect().height;
    return this.adjust(t, r, d, s, h2);
  }
  adjust(t, n, o, i, r) {
    let s, d, h2, y2;
    const I = document.documentElement.getBoundingClientRect().width, L = document.documentElement.getBoundingClientRect().height;
    return (i + n) / 2 < I / 2 ? (t.style.setProperty("--left", `${n}px`), t.style.setProperty("--right", ""), y2 = void 0, s = Math.max(0, n)) : (t.style.removeProperty("--left"), t.style.setProperty("--right", `${I - i}px`), s = void 0, y2 = Math.max(0, I - i)), (o + r) / 2 < L / 2 ? (t.style.setProperty("--top", `${o}px`), t.style.setProperty("--bottom", ""), h2 = void 0, d = Math.max(0, o)) : (t.style.setProperty("--top", ""), t.style.setProperty("--bottom", `${L - r}px`), d = void 0, h2 = Math.max(0, L - r)), {
      left: s,
      right: y2,
      top: d,
      bottom: h2
...
let $ = class extends _s {
  constructor() {
    super(...arguments), this.initialMouseDownPosition = null, this.dragging = false, this.mouseDownListener = (e) => {
      ...
      this.dragging && (this.setOverlayVisibility(false), f.dragging(this, e));
    }, this.documentMouseUpListener = (e) => {
      if (this.dragging) {
        const t = f.dragging(this, e);
        zi.setActivationButtonPosition(t), this.setOverlayVisibility(true);
      }
      ...
      if (this.dragging) {
        e?.stopPropagation(), this.dragging = false;
        return;
      }
      if (_$1.active && this.handleAttentionRequiredOnClick()) {
      ...
      return e ? e.panel && !e.floating ? ($$1.emit("open-attention-required-drawer", null), true) : (Jt.clearAttention(), true) : false;
  ...
  connectedCallback() {
    super.connectedCallback(), this.reaction(
      () => Jt.attentionRequiredPanelTag,
      () => {
        this.toggleAttribute(fl, Jt.attentionRequiredPanelTag !== null);
      }
    ), this.reaction(
      () => _$1.active,
      () => {
        this.toggleAttribute("active", _$1.active);
      },
    ...
    const e = zi.getActivationButtonPosition();
  ...
  render() {
        ...
        children: [
          {
            component: v("vaadin-menu-bar-item", {
              ...
              hint: zi.isActivationShortcut() ? Cl.toggleCopilot : void 0
            }),
            action: "copilot"
          },
          {
            ...
            children: [
              {
                component: v("vaadin-menu-bar-item", {
                  ...
                  hint: zi.isActivationShortcut() ? "✓" : void 0
                }),
                action: "shortcut"
              },
              {
                component: v("vaadin-menu-bar-item", {
                  ...
                  hint: zi.isActivationAnimation() ? "✓" : void 0
                }),
    ...
    return _$1.active && (_$1.idePluginState?.supportedActions?.find((t) => t === "undo") && (e[0].children = [
      {
        component: v("vaadin-menu-bar-item", {
          label: "Undo",
          hint: Cl.undo
  ...
  handleMenuItemClick(e) {
    switch (e.action) {
      case "copilot":
        ...
        break;
      case "spotlight":
        _$1.setSpotlightActive(!_$1.spotlightActive);
        break;
      case "shortcut":
        zi.setActivationShortcut(!zi.isActivationShortcut());
        break;
      case "animate-on-activate":
        zi.setActivationAnimation(!zi.isActivationAnimation());
        break;
      case "undo":
      case "redo":
        $$1.emit("undoRedo", { undo: e.action === "undo" });
        break;
      case "feedback":
        ...
        break;
      case "welcome":
        _$1.setWelcomeActive(true), _$1.setSpotlightActive(true);
        break;
      case "shortcuts":
        Jt.updatePanel("copilot-shortcuts-panel", {
          floating: true
        });
        break;
    }
  ...
  firstUpdated() {
    this.setMenuBarOnClick(), y(this.shadowRoot);
  }
};
q([
  p("vaadin-menu-bar")
...
let P = class extends _s {
  constructor() {
    super(...arguments), this.panelTag = "", this.floatingResizingStarted = false, this.resizingInDrawerStarted = false, this.toggling = false, this.rectangleBeforeResizing = null, this.floatingResizeHandlerMouseMoveListener = (e) => {
      ...
      if (n < s ? i < s ? (d = "nw-resize", this.setAttribute(g, "top left")) : r < s ? (d = "sw-resize", this.setAttribute(g, "bottom left")) : (d = "col-resize", this.setAttribute(g, "left")) : o < s ? i < s ? (d = "ne-resize", this.setAttribute(g, "top right")) : r < s ? (d = "se-resize", this.setAttribute(g, "bottom right")) : (d = "col-resize", this.setAttribute(g, "right")) : r < s ? (d = "row-resize", this.setAttribute(g, "bottom")) : i < s && (d = "row-resize", this.setAttribute(g, "top")), d !== "") {
        const h2 = window.getComputedStyle(this), y2 = Number.parseInt(h2.borderTopWidth, 10), I = Number.parseInt(h2.borderTopWidth, 10), L = Number.parseInt(h2.borderLeftWidth, 10), W = Number.parseInt(h2.borderRightWidth, 10);
        this.rectangleBeforeResizing = this.getBoundingClientRect(), this.rectangleBeforeResizing.width -= L + W, this.rectangleBeforeResizing.height -= y2 + I, this.style.setProperty("--resize-cursor", d);
      } else
      ...
      this.hasAttribute(B) && (e.stopPropagation(), e.preventDefault(), f.anchorLeftTop(this), this.floatingResizingStarted = true, this.toggleAttribute("resizing", true), vl(() => {
        _$1.sectionPanelResizing = true;
      }));
      ...
      if (!this.floatingResizingStarted || !this.panelInfo?.floating)
        return;
      e.stopPropagation(), e.preventDefault(), this.floatingResizingStarted = false, vl(() => {
        _$1.sectionPanelResizing = false;
      });
      const { width: t, height: n } = this.getBoundingClientRect(), { left: o, top: i, bottom: r, right: s } = f.anchor(this), d = window.getComputedStyle(this.container), h2 = Number.parseInt(d.borderTopWidth, 10), y2 = Number.parseInt(d.borderTopWidth, 10);
      Jt.updatePanel(this.panelInfo.tag, {
        width: t,
        height: n - (h2 + y2),
        floatingPosition: {
      ...
      this.toggling && (this.toggling = false, f.anchor(this));
    }, this.resizeInDrawerMouseDownListener = (e) => {
      e.button === 0 && (this.resizingInDrawerStarted = true, this.setAttribute("resizing", ""), $$1.emit("user-select", { allowSelection: false }));
      ...
      this.style.setProperty("--section-height", `${n}px`), Jt.updatePanel(this.panelInfo.tag, {
        height: n
      });
    }, this.resizeInDrawerMouseUpListener = () => {
      this.resizingInDrawerStarted && (this.panelInfo?.floating || (this.resizingInDrawerStarted = false, this.removeAttribute("resizing"), $$1.emit("user-select", { allowSelection: true }), this.style.setProperty("--section-height", `${this.getBoundingClientRect().height}px`)));
    }, this.sectionPanelMouseEnterListener = () => {
      this.hasAttribute(fl) && (this.removeAttribute(fl), Jt.clearAttention());
    }, this.contentAreaMouseDownListener = () => {
      Jt.addFocusedFloatingPanel(this.panelInfo);
    }, this.documentMouseUpEventListener = () => {
      document.removeEventListener("mousemove", this.draggingEventListener), this.panelInfo?.floating && (this.toggleAttribute("dragging", false), _$1.setSectionPanelDragging(false));
    }, this.panelHeaderMouseDownEventListener = (e) => {
      e.button === 0 && (e.target instanceof HTMLButtonElement && e.target.getAttribute("part") === "title-button" || (Jt.addFocusedFloatingPanel(this.panelInfo), !this.hasAttribute(g) && (f.draggingStarts(this, e), document.addEventListener("mousemove", this.draggingEventListener), _$1.setSectionPanelDragging(true), this.panelInfo?.floating ? this.toggleAttribute("dragging", true) : this.parentElement.sectionPanelDraggingStarted(this, e), e.preventDefault(), e.stopPropagation())));
      ...
      const e = Jt.getPanelByTag(this.panelTag);
      ...
      if (!this.panelInfo)
        return E;
      let e;
      return this.panelInfo.panel === void 0 ? e = "Close the popup" : e = this.panelInfo.floating ? `Dock ${this.panelInfo.header} to ${this.panelInfo.panel}` : `Open ${this.panelInfo.header} as a popup`, _r`
      <button
        part="popup-button"
    ...
    `;
      ...
      if (this.panelInfo)
        if (e.stopPropagation(), Vl(this), this.panelInfo?.floating)
          Jt.updatePanel(this.panelInfo?.tag, { floating: false });
        else {
          let t;
          ...
          n === void 0 && this.panelInfo.expanded && (n = Number.parseInt(window.getComputedStyle(this).height, 10)), this.parentElement.forceClose(), Jt.updatePanel(this.panelInfo?.tag, {
            floating: true,
      ...
      this.panelInfo && (e.stopPropagation(), f.anchorLeftTop(this), Jt.updatePanel(this.panelInfo.tag, {
  ...
  connectedCallback() {
    super.connectedCallback(), this.setAttribute("role", "region"), this.reaction(
      ...
      () => {
        const e = Jt.getAttentionRequiredPanelConfiguration();
        this.toggleAttribute(fl, e?.tag === this.panelTag && e?.floating);
      }
      ...
      () => {
        requestAnimationFrame(() => {
          this.toggleAttribute(
            ...
            _$1.operationInProgress === Dl.DragAndDrop && this.panelInfo?.floating && !this.panelInfo.showWhileDragging
          );
        });
      }
    ), this.reaction(
      () => Jt.floatingPanelsZIndexOrder,
      () => {
        this.style.setProperty("--z-index-focus", `${Jt.getFloatingPanelZIndex(this.panelTag)}`);
      },
      { fireImmediately: true }
  ...
  willUpdate(e) {
    super.willUpdate(e), e.has("panelTag") && (this.panelInfo = Jt.getPanelByTag(this.panelTag), this.setAttribute("aria-labelledby", this.panelInfo.tag.concat("-title"))), this.toggleAttribute("floating", this.panelInfo?.floating);
  }
  updated(e) {
    super.updated(e), this.setCssSizePositionProperties();
  }
  firstUpdated(e) {
    super.firstUpdated(e), document.addEventListener("mouseup", this.documentMouseUpEventListener), this.headerDraggableArea.addEventListener("mousedown", this.panelHeaderMouseDownEventListener), this.toggleAttribute("expanded", this.panelInfo?.expanded), Rl(this), this.setCssSizePositionProperties(), this.contentArea.addEventListener("mousedown", this.contentAreaMouseDownListener), this.drawerResizeElement.addEventListener("mousedown", this.resizeInDrawerMouseDownListener);
  }
  render() {
    return this.panelInfo ? _r`
      <div part="container">
        <div part="header" class="drag-handle">
          ${this.panelInfo.expandable !== false ? _r` <button
                part="toggle-button"
...
C([
  p('[part="drawer-resize"]')
], P.prototype, "drawerResizeElement", 2);
C([
  p('[part="container"]')
], P.prototype, "container", 2);
P = C([
  Ya("copilot-section-panel-wrapper")
], P);
$$1.on("undoRedo", (e) => {
  const t = e.detail.files ?? K();
  e.detail.undo ? $$1.send("copilot-plugin-undo", { files: t }) : $$1.send("copilot-plugin-redo", { files: t });
});
var ze = (e, t, n, o) => {
  for (var i = t, r = e.length - 1, s; r >= 0; r--)
    (s = e[r]) && (i = s(i) || i);
  return i;
};
let Y = class extends _s {
  ...
  render() {
    return _r`<div class="notification-tray">
      ${_$1.notifications.map((e) => this.renderNotification(e))}
    </div>`;
  }
      ...
      <div
        ...
        <div class="message-content">
          ...
          <div class="message-details" ?hidden="${!e.details && !e.link}">
            ${Ol(e.details)}
            ${e.link ? _r`<a class="ahreflike" href="${e.link}" target="_blank">Learn more</a>` : ""}
          </div>
          ${e.dismissId ? _r`<div
...
Y = ze([
  Ya("copilot-notifications-container")
], Y);
function Pe(e) {
...
const V = al(() => {
  $$1.emit("component-tree-updated", {});
});
$$1.on("vite-after-update", () => {
  V();
});
const H = window?.Vaadin?.connectionState?.stateChangeListeners;
H ? H.add((e, t) => {
  e === "loading" && t === "connected" && _$1.active && V();
}) : console.warn("Unable to add listener for connection state changes");
$$1.on("copilot-plugin-state", (e) => {
  _$1.setIdePluginState(e.detail), e.detail.active && Ii("plugin-active", `${e.detail.version}-${e.detail.ide}`), e.preventDefault();
});
